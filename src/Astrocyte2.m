% Astrocyte class including SC, AC, PVS for NEW model with neuron. 
% Use with NVU2()

classdef Astrocyte2 < handle
    properties
        params
        u0
        index
    ...
    methods
        function self = Astrocyte2(varargin)
        ...
        function [du, varargout] = rhs(self, t, u, J_KIR_i, J_Na_n)
            ...
            if nargout == 2                         % Need to include here (eg J) if want to plot
